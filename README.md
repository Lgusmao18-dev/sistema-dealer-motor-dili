...
# 🏍️ Sistema Informasaun GIS Dealer Motor Dili

**A Modern Web-Based GIS Information System for Motorcycle Dealers in Dili, Timor-Leste**
...
*   **✉️ Customer Feedback System:** Track and manage customer messages and reviews (Komentariu Cliente).
*   **📈 Analytics:** Monitor total registered dealers, motorcycle brands, customer messages, and site visits.
